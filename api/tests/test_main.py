...
def test_bug_interactions():
    ...
    assert response_create.status_code == 200
    assert response_create.json() == {'title': 'string', 'description': 'string', 'is_open': True, 'owner_id': 1}
    assert response_update.status_code == 200 
    assert response_update.json() == {'title': 'string', 'description': 'string', 'is_open': True, 'owner_id': 1}
